      ...
      <Card className="w-[460px] h-fit border:none bg-transparent absolute bottom-10 left-45 z-10">
        <CardHeader>
          <CardTitle>
            ...
            <h2 className="text-[42px] leading-10 text-[#FFFFFF] font-extrabold font-sans pt-4">
              {props.moviename}
            </h2>
          ...
          <CardDescription className="text-[16px] text-justify text-[#FAFAFA] leading-5 font-normal font-sans mt-4">
            {props.description}
            <Button
              variant="outline"
              className="w-fit h-12 flex gap-2 items-center justify-center bg-[#F4F4F5] py-0 mt-6 cursor-pointer"
            >
              <Play className="text-[#18181B] size-4" />
              <p className="text-[18px] leading-5 text-[#18181B] font-medium font-sans">
                {props.btn}
              </p>
            </Button>
          </CardDescription>
